...
struct ExampleRepository: Sendable {
    var fetchItems: @Sendable () async throws -> [ExampleItem]
    var fetchDetail: @Sendable (_ id: Int) async throws -> ExampleDetail
    var createItem: @Sendable (
        _ title: String,
        _ content: String,
        _ category: ExampleDetail.Category
    ) async throws -> ExampleDetail
    var updateItem: @Sendable (_ id: Int, _ title: String, _ isCompleted: Bool) async throws -> ExampleItem
    var deleteItem: @Sendable (_ id: Int) async throws -> Void
}

// MARK: - TestDependencyKey

extension ExampleRepository: TestDependencyKey {
    static let testValue = ExampleRepository()
}
